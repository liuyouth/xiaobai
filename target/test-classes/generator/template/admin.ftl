...
<head>
    ...
    <title>小白杂货铺 | ${modelNameUpperCamel} </title>
...
<div id="wrapper">
                    ...
                    <div class="dropdown profile-element" style="    text-align: center;"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong
                                    class="font-bold">${modelNameUpperCamel}</strong>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>${modelNameUpperCamel}</h2>
                <span style="color: #bdbdbd;font-weight: 300;">${modelNameUpperCamel} 操作管理</span>
                <ol class="breadcrumb">
                    <li>
                        <a href="#">Home</a>
                    </li>
                    <li class="active">
                        <strong>${modelNameUpperCamel}</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-${modelNameLowerCamel}">
